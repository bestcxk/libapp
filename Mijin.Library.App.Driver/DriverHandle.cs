...
namespace Mijin.Library.App.Driver
{
    public class DriverHandle : IDriverHandle
    {
        ...
        private IVbarQrCode _vbarQrCode { get; }
        ...
        public DriverHandle(ISystemFunc systemFunc, IWenhuaSIP2Client sIP2Client, ICabinetLock cabinetLock,
            ...
            IQrCode qrCode, ICkDoorController ckDoorController, ITrack track, IMultiGrfid multiGrfid, ISudo sudo, IWjSIP2Client wjSIP2Client, IVbarQrCode vbarQrCode)
        {
