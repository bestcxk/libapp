using Mijin.Library.App.Driver.Drivers.LibrarySIP2.Models.JpSip2Valid;
using SIP2Client.Common.Sip2Attribute;

namespace Mijin.Library.App.Driver.Drivers.LibrarySIP2.Models.JpSip2Response
{
    /// <summary>
    /// 查询读者信息响应
    /// </summary>
    public class JpSip2ReaderResponse : JpSip2ValidReader
    {
        /// <summary>
        /// 读者状态
        /// </summary>
