...
namespace IsUtil
{
    ...
    public static partial class Extensions {
        ...
        /// <param name="left">左操作数</param>
        /// <param name="right">右操作数</param>
        public static Expression<Func<T, T2, T3, bool>> And<T, T2,T3>(this Expression<Func<T, T2, T3, bool>> left, Expression<Func<T, T2, T3, bool>> right)
        {
            if (left == null)
                return right;
            if (right == null)
        ...
        /// <summary>
        /// 与操作表达式
        /// 如果[check]表达式返回的是 false，则直接返回[原对象]，否则返回[计算对象]
        /// </summary>
        /// <typeparam name="T">对象类型</typeparam>
        /// <param name="left">左操作数</param>
        /// <param name="right">右操作数</param>
        /// <param name="check">条件运算</param>
        public static Expression<Func<T, bool>> AndIF<T>(this Expression<Func<T, bool>> left, Expression<Func<T, bool>> right, bool check)
        {
            if (check == false)
            {
                return left;
        ...
        /// <param name="right">右操作数</param>
        /// <param name="check">条件运算</param>
        public static Expression<Func<T, T2, bool>> AndIF<T, T2>(this Expression<Func<T, T2, bool>> left, Expression<Func<T, T2, bool>> right, bool check)
        {
            if (check == false)
            {
                return left;
        ...
        /// <param name="right">右操作数</param>
        /// <param name="check">条件运算</param>
        public static Expression<Func<T, T2, T3, bool>> AndIF<T, T2, T3>(this Expression<Func<T, T2, T3, bool>> left, Expression<Func<T, T2, T3, bool>> right, bool check)
        {
            if (check == false)
            {
                return left;
        ...
        /// <param name="right">右操作数</param>
        /// <param name="check">条件运算</param>
        public static Expression<Func<T, bool>> OrIF<T>(this Expression<Func<T, bool>> left, Expression<Func<T, bool>> right, bool check)
        {
            if (check == false)
            {
                return left;
