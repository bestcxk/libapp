...
namespace IsUtil.Maps {
    ...
    public static class Extensions {
        ...
        /// 将源集合深拷贝到目标集合
        /// </summary>
        /// <typeparam name="TDestination">目标元素类型,不要加List</typeparam>
        /// <param name="source">源集合</param>
        /// <returns>目标对象</returns>
        private static List<TDestination> JsonMapList<TDestination>(object source)
        {
            return JsonMap<List<TDestination>>(source);
        }
        ...
        public static List<TDestination> JsonMapToList<TDestination>(this System.Collections.IEnumerable source)
        {
